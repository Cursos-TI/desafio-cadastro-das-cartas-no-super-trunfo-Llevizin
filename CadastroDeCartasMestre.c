...
int main(){
    ...
    float super_poder1; // Declara uma variável do tipo float
    ...
    float super_poder2; // Declara uma variável do tipo float
    ...
    super_poder1 = (float) populacao1 + area1 + pib1 + (float) numero_pontos_turisticos1 + pib_per_capita1 + (1.0 / densidade_populacional1);
    // Calculo do Super Poder - Carta 1
    super_poder2 = (float) populacao2 + area2 + pib2 + (float) numero_pontos_turisticos2 + pib_per_capita2 + (1.0 / densidade_populacional2);
    ...
    //Resultado das Comparações Carta 1(1) e Carta 2(0)
    printf("\nComparações de Cartas:\n");

    printf("População: %d\n", populacao1 > populacao2); // Exibe 1 se "populacao1" for maior que "populacao2", senão exibe 0
    printf("Área: %d\n", area1 > area2); // Exibe 1 se "area1" for maior que "area2", senão exibe 0
    printf("PIB: %d\n", pib1 > pib2); // Exibe 1 se "pib1" for maior que "pib2", senão exibe 0
    printf("Pontos Turísticos %d\n", numero_pontos_turisticos1 > numero_pontos_turisticos2); // Exibe 1 se "numero_pontos_turisticos1" for maior que "numero_pontos_turisticos2", senão exibe 0
    printf("Densidade Populacional: %d\n", densidade_populacional1 > densidade_populacional2); // Exibe 1 se "densidade_populacional1" for maior que "densidade_populacional2", senão exibe 0
    printf("PIB per Capita: %d\n", pib_per_capita1 > pib_per_capita2); // Exibe 1 se "pib_per_capita" for maior que "pib_per_capita2", senão exibe 0
    printf("Super Poder: %d\n", super_poder1 > super_poder2); // Exibe 1 se "super_poder1" for maior que "super_poder2", senão exibe 0
